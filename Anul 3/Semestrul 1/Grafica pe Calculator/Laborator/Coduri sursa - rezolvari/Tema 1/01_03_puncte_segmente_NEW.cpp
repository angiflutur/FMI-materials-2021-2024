...
void CreateVBO(void)
{
    ...
    GLfloat Vertices[] = {
        -0.1f, 0.3f, 0.0f, 1.0f,     //linie roz   /
        0.3f,  0.6f, 0.0f, 1.0f,

        -0.1f, 0.3f, 0.0f, 1.0f,     //linie roz   /
        -1.0f,  -0.8f, 0.0f, 1.0f,

       -0.1f, 0.0f, 0.0f, 1.0f,      //linie mov   /
        0.3f,  0.3f, 0.0f, 1.0f,

        -0.3f,  0.3f, 0.0f, 1.0f,    //punct roz

        -0.6f,  0.0f, 0.0f, 1.0f,    //punct negru
        
        0.5f, 0.9f, 0.0f, 1.0f,
        0.6f,  0.4f, 0.0f, 1.0f,     //linie mov  \
        
        -0.6f,  -0.5f, 0.0f, 1.0f,   //punct albastru 

        -0.8f,  -0.8f, 0.0f, 1.0f,   //punct albastru

        -0.81f,  -0.81f, 0.0f, 1.0f,   //punct albastru

    };

    //  Culorile in spectrul RGB ca atribute ale varfurilor;
    GLfloat Colors[] = {
        1.0f, 0.0f, 0.6f, 1.0f,    // x y 0.0f 1.0f // x si y intre -1 si 1
        1.0f, 0.0f, 0.6f, 1.0f,    //roz

        1.0f, 0.0f, 0.6f, 1.0f,
        1.0f, 0.0f, 0.6f, 1.0f,    //roz

        0.5f, 0.0f, 1.0f, 1.0f,
        0.5f, 0.0f, 1.0f, 1.0f,    //mov
...
int main(int argc, char* argv[])
{
    ...
    glutInitWindowPosition(300, 100);                        //  Pozitia initiala a ferestrei;
    glutInitWindowSize(500, 400);                            //  Dimensiunea ferestrei;
