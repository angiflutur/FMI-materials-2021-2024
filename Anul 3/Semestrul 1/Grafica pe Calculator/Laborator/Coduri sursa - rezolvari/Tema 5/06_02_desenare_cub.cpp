...
// ================================================
// | Cursul VI - 06_02_desenare_cub.cpp       |
// ============================================
// 
...
void CreateVBO(void)
{
	...
	GLfloat Vertices[] =
	{
		...
		//	Coordonate;					Culori;			
		-25.0f, -25.0f,  50.0f,  1.0f,  1.0f, 0.0f, 0.0f,
...
int main(int argc, char* argv[])
{
	...
	glutCreateWindow("Desenarea unui cub folosind testul de adancime - OpenGL <<nou>>");		//	Creeaza fereastra de vizualizare, indicand numele acesteia;
