...
void CreateVBO(void)
{
    ...
    GLfloat Vertices[] = {
        -100, -100, 0, 1,       //  Primele 4 varfuri au a 4a coordonata 1;
         100, -100, 0, 1,
         100,  100, 0, 1,
        -100,  100, 0, 1,
    //
        -100, -100, 0, 0.0,     //  Al 5lea varf are a 4a coordonata 0;
    //
        -100, -100, 0, 0.5,     //  Urmatoarele 4 varfuri au a 4a coordonata 0.5;
         100, -100, 0, 0.5,
         100,  100, 0, 0.5,
        -100,  100, 0, 0.5,
  };
...
void RenderFunction(void)
{
    ...
    glPolygonMode(GL_FRONT_AND_BACK,GL_LINE); //  Setarea parametrilor privind fata/spatele poligoanelor;
