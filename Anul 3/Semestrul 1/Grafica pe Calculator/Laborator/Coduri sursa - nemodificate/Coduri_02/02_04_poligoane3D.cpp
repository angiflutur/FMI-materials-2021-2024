...
// ================================================
// | Laboratorul II - 02_04_poligoane3D.cpp |
// ==========================================
//
...
//	Acest cod sursa este un "echivalent" al codului 02_03_poligoane3D_ex1_OLD.cpp
//
//
//  Biblioteci
...
{
	ProgramId = LoadShaders("02_04_Shader.vert", "02_04_Shader.frag");
...
void RenderFunction(void)
{
	...
	//  De testat si alte optiuni: GL_POLYGON, GL_QUADS
...
int main(int argc, char* argv[])
{
	...
	glutCreateWindow("Poligoane 3D - OpenGL <<nou>>");			//	Creeaza fereastra de vizualizare, indicand numele acesteia;
